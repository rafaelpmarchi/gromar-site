...
const translations = {
  pt: {
    ...
    'srv.pkg.li2': 'Inspeção dimensional CNC',
    'srv.pkg.li3': 'Usinagem sob medida',
    ...
    'prt.tag': 'Nosso trabalho',
    'prt.title': 'Portfólio de Soluções',
    'prt.sub': 'Exemplos de projetos desenvolvidos com tecnologia e precisão',
    'prt.p1.title': 'Bucha Labirinto para Turbina',
    'prt.p1.desc': 'Componente de alta precisão para sistemas de turbinas, garantindo vedação e durabilidade em ambientes de alta rotação.',
    'prt.p1.tag': 'Energia',
    'prt.p2.title': 'Inspeção Tridimensional CNC',
    'prt.p2.desc': 'Processo de controle de qualidade com medição tridimensional computadorizada, assegurando tolerâncias micrométricas.',
    'prt.p2.tag': 'Qualidade',
    'prt.p3.title': 'Selecionador e Inspeção de Tampas',
    'prt.p3.desc': 'Equipamento automatizado para seleção e inspeção de tampas plásticas, otimizando a produção em linhas de embalagem.',
    'prt.p3.tag': 'Embalagens',
  ...
  es: {
    ...
    'srv.pkg.li2': 'Inspección dimensional CNC',
    'srv.pkg.li3': 'Mecanizado a medida',
    ...
    'prt.tag': 'Nuestro trabajo',
    'prt.title': 'Portafolio de Soluciones',
    'prt.sub': 'Ejemplos de proyectos desarrollados con tecnología y precisión',
    'prt.p1.title': 'Buje Laberinto para Turbina',
    'prt.p1.desc': 'Componente de alta precisión para sistemas de turbinas, garantizando sellado y durabilidad en entornos de alta rotación.',
    'prt.p1.tag': 'Energía',
    'prt.p2.title': 'Inspección Tridimensional CNC',
    'prt.p2.desc': 'Proceso de control de calidad con medición tridimensional computarizada, asegurando tolerancias micrométricas.',
    'prt.p2.tag': 'Calidad',
    'prt.p3.title': 'Seleccionador e Inspección de Tapas',
    'prt.p3.desc': 'Equipo automatizado para selección e inspección de tapas plásticas, optimizando la producción en líneas de embalaje.',
    'prt.p3.tag': 'Embalajes',
  ...
  en: {
    ...
    'srv.pkg.li2': 'CNC dimensional inspection',
    'srv.pkg.li3': 'Custom machining',
    ...
    'prt.tag': 'Our work',
    'prt.title': 'Solutions Portfolio',
    'prt.sub': 'Examples of projects developed with technology and precision',
    'prt.p1.title': 'Turbine Labyrinth Bushing',
    'prt.p1.desc': 'High-precision component for turbine systems, ensuring sealing and durability in high-rotation environments.',
    'prt.p1.tag': 'Energy',
    'prt.p2.title': 'CNC Three-Dimensional Inspection',
    'prt.p2.desc': 'Quality control process with computerized three-dimensional measurement, ensuring micrometric tolerances.',
    'prt.p2.tag': 'Quality',
    'prt.p3.title': 'Cap Selector and Inspection',
    'prt.p3.desc': 'Automated equipment for selecting and inspecting plastic caps, optimizing production on packaging lines.',
    'prt.p3.tag': 'Packaging',
